...
const STATUS_MAP: Record<OrderStatus, StatusConfig> = {
  ...
  PRODUCTION_QUEUED: { label: "Antrian Cetak", color: "bg-status-yellow/15 text-status-yellow-text border-status-yellow/30", dotColor: "bg-status-yellow" },
  PRODUCTION_ASSIGNED: { label: "Antrian Cetak", color: "bg-status-blue/15 text-status-blue border-status-blue/30", dotColor: "bg-status-blue" },
  PRODUCTION_STARTED: { label: "Proses Cetak", color: "bg-status-blue/15 text-status-blue border-status-blue/30", dotColor: "bg-status-blue", pulse: true },
  PRODUCTION_PAUSED: { label: "Cetak Dijeda", color: "bg-status-yellow/15 text-status-yellow-text border-status-yellow/30", dotColor: "bg-status-yellow" },
  PRODUCTION_COMPLETE: { label: "Cetak Selesai", color: "bg-status-blue/15 text-status-blue border-status-blue/30", dotColor: "bg-status-blue" },
