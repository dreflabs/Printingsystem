...
export function PINModal({ open, onClose, onSuccess, title = "Otorisasi Admin", description = "Masukkan PIN Admin untuk melanjutkan tindakan ini." }: PINModalProps) {
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className={cn(
              ...
              error ? "border-status-red focus:ring-status-red/20 text-status-red" : "border-border text-primary focus:border-status-yellow focus:ring-status-yellow/20"
            )}
          />
